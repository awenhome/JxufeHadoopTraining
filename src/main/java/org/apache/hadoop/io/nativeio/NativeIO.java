/**
 * @简介 解决Exception: org.apache.hadoop.io.nativeio.NativeIO$Windows.access0(Ljava/lang/String;I)Z 等一系列问题
 ...
 *  解决方法二：重写NativeIO类（即本类替换jar中的类），具体Search："return access0"==>return true;
 *  /
/**
